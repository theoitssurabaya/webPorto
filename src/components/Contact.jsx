                ...
                <div style={{ display: "flex", flexDirection: "column", gap: "32px" }}>
                    ...
                    <div style={{ display: "flex", flexDirection: "column", gap: "24px" }}>
                        ...
                        <div style={{ display: "flex", alignItems: "center", gap: "16px" }}>
                            ...
                            <div>
                                <p style={{ fontSize: "12px", fontWeight: "bold", color: "var(--text-dim)", textTransform: "uppercase", letterSpacing: "1px", margin: "0 0 4px 0" }}>{t.emailLabel}</p>
                        ...
                        <div style={{ display: "flex", alignItems: "center", gap: "16px" }}>
                            ...
                            <div>
                                <p style={{ fontSize: "12px", fontWeight: "bold", color: "var(--text-dim)", textTransform: "uppercase", letterSpacing: "1px", margin: "0 0 4px 0" }}>{t.locationLabel}</p>
                        ...
                        <div style={{ display: "flex", alignItems: "center", gap: "16px" }}>
                            ...
                            <div>
                                <p style={{ fontSize: "12px", fontWeight: "bold", color: "var(--text-dim)", textTransform: "uppercase", letterSpacing: "1px", margin: "0 0 4px 0" }}>{t.phoneLabel}</p>
